...
| Phase | Time | Format |
|---|---|---|
| Slide-driven lecture | ~90 min | Instructor uses [`slides/L05_slides.pptx`](./slides/L05_slides.pptx) (~28 slides with speaker notes) |
...
slides/
  L05_slides.pptx                      ← Instructor slide deck (~28 slides)
